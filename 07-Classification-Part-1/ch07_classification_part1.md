...
<!-- [IMAGE: images/ch07/fig-7-0-sorting-hat-classification.png]
Alt text: A young Latina woman at a desk examining colorful cards being sorted into two labeled trays in a warm modern classroom setting.
Nano Banana Pro Prompt: "A young Latina woman in her early 20s with dark hair in a low ponytail, wearing a teal blouse, sits at a wooden desk in a bright modern classroom. She holds a stack of colorful index cards — each card a different pastel color (coral, gold, lavender, mint). In front of her, two wooden sorting trays are labeled with small hand-lettered signs: 'Approved' on the left and 'Denied' on the right. Several cards are already sorted into each tray; she is placing one coral card into the Approved tray with her right hand. On the desk beside the trays, a laptop screen shows a simple scatter plot with two colored clusters. Through the window behind her, a bright South Florida sky with a single palm tree is visible. The lighting is warm natural daylight from the window, casting soft shadows across the desk. Style: editorial textbook illustration with soft digital watercolor textures, clean lines, and a warm coral-and-turquoise color palette. Composition is a medium shot centered on the woman's hands and the sorting action, with the laptop and window as secondary elements. No text other than the two tray labels 'Approved' and 'Denied.'"
-->
